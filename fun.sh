...
export -f context.eventName context.sha context.ref context.workflow context.action \
           context.actor context.job context.runAttempt context.runNumber context.runId \
           context.apiUrl context.serverUrl context.graphqlUrl context.payload \
